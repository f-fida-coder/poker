    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 font-medium">Create your account and start playing</p>
        </div>
        ...
        <Card hover={false} glow>
          ...
          <p className="mt-6 text-center text-sm text-gray-700 font-medium">
            ...
            <Link to="/auth/signin" className="text-tropical-parrotBlue hover:text-tropical-gold transition-colors font-bold">
              Sign in
            </Link>
          </p>
        </Card>
